...
const PHASES = [
  ...
  { id: 'build1',   label: 'Build 1',   weeks: '10–19', dates: 'Aug – Sep 2026',       goal: 'VO2max steigern (Ziel 54–56). HIIT, Schwelle, Stationsspezifik, Transitions.' },
  { id: 'peak1',    label: 'Peak 1',    weeks: '20–21', dates: 'Okt 2026',             goal: 'Rennsimulation. Wettkampfpace. Vollsimulationen.' },
  { id: 'race1',    label: '🏆 Race 1', weeks: '22',    dates: '18./19. Okt 2026',    goal: 'Hyrox Karlsruhe · Ziel Sub 75 Min' },
  { id: 'recovery', label: 'Recovery',  weeks: '23–24', dates: 'Ende Okt – Nov 2026',  goal: 'Aktive Erholung. Race-Analyse. Schwächen für Block 2 definieren.' },
...
function getCurrentPhase(): string {
  ...
  if (week <= 19) return 'build1'
  if (week <= 21) return 'peak1'
  if (week <= 22) return 'race1'
